...
{
    curr_ball.alpha_x = get_new_x(curr_degrees, curr_ball);
    curr_ball.alpha_y = get_new_y(curr_degrees, curr_ball);
    ...
    switch (wall_side)
    {
        case COLLISION_CASE_BOTTOM:
            ...
            {
                curr_ball.alpha_y = curr_ball.alpha_y * (-1);
            ...
            {
                curr_ball.alpha_x = curr_ball.alpha_x * (-1);
                curr_ball.alpha_y = curr_ball.alpha_y * (-1);
                curr_ball.recent_x = curr_ball.curr_x;
                curr_ball.recent_y = curr_ball.curr_y;
                return;
